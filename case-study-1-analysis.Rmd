...
attr(beer_brewery_byState$ABV_rank, "label") <-"The ranking of ABV median against other states(e.g. #1 has the highest ABV)"                       
attr(beer_brewery_byState$ABV_sd_rank, "label") <-"The ranking of ABV standard deviation against other states(e.g. #1 has the highest standard deviation)"      
attr(beer_brewery_byState$IBU_rank, "label") <-"The ranking of IBU median against other states(e.g. #1 has the highest IBU)"                       
attr(beer_brewery_byState$IBU_sd_rank, "label") <-"The ranking of IBU standard deviation against other states(e.g. #1 has the highest standard deviation)"      
attr(beer_brewery_byState$Ounce_rank, "label") <-"The ranking of Ounce median against other states(e.g. #1 has the highest Ounce)"                        
attr(beer_brewery_byState$Ounce_sd, "label") <-"The ranking of Ounce standard deviation against other states(e.g. #1 has the highest standard deviation)"                  
